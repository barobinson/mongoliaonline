...
1. Create a data set that contains only the median stays for males and females.
...
```{r group_ex_1-hint-3}
hospds %>% group_by(Gender) %>% summarise(median(TreatDays))
```
...
```{r group_ex_2-hint-3}
hospds %>% group_by(Education, Gender) %>% summarise(median(Age))
```
