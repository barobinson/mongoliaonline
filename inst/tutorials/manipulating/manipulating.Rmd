...
1. Find all the patients admitted to Hospital no. 212.
...
<!-- uliral %>% filter(___ == ___) -->
<!-- ``` -->

<!-- ```{r filter_ex_1-hint-3} -->
<!-- uliral %>% filter(Hospital == 212) -->
<!-- ``` -->
...
uliral %>% filter(Hospital == 212) %>% nrow()
```
```{r filter_ex_1b-check}
grade_result(
  pass_if(~ .result == 1, "Correct!"),
...
<!-- # uliral %>% filter(Hospital ___ & Age ___) -->
<!-- # ``` -->
<!-- #  -->
<!-- # ```{r filter_ex_2-hint-3} -->
<!-- # uliral %>% filter(Hospital == 2162636 & Age > 21) -->
<!-- # ``` -->
...
```{r filter_ex_2-check}
grade_result(
  pass_if(~ identical(.result, uliral %>% filter(Hospital == 2162636 & Age > 21)) , "Correct!"),
  fail_if(~ identical(.result, uliral %>% filter(Hospital == 2162636)) , "You also need to filter by age"),
   fail_if(~ identical(.result, uliral %>% filter(Age > 21)) , "You also need to filter by hospital"),
  default_message = "Try again"
)
```
...
<!-- uliral %>% filter(___) %>% slice(___) -->
<!-- ``` -->

<!-- ```{r filter_ex_3-hint-2} -->
<!-- uliral %>% filter(Age == 79) %>% slice(___) -->
<!-- ``` -->

<!-- ```{r filter_ex_3-hint-3} -->
<!-- uliral %>% filter(Age == 79) %>% slice(1:3) -->
<!-- ``` -->
